...
inline juce::File userRecordingsDir() { return userLibraryRoot().getChildFile("Recordings"); }

inline juce::File userPresetsDir() { return userLibraryRoot().getChildFile("Presets"); }
