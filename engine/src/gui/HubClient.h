...
public:
    ...
    static std::string updatePlatform() {
        const bool appImage =
            juce::SystemStats::getEnvironmentVariable("APPIMAGE", {}).isNotEmpty();
        return hubproto::updatePlatformTag(
            PackLoader::platformTag(), appImage,
