...
inline juce::Image hyphaImage(int rowH, int parity) {
    ...
    juce::ColourGradient grad(Palette::border.withAlpha(alpha::scrim), cx, y0,
                              Palette::border.withAlpha(alpha::scrim), cx, y1, false);
    ...
    g.setColour(Palette::border.withAlpha(alpha::heavy));
