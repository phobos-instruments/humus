...
public:
    SpectrumScopeView(EngineHost& host, std::string name)
    ...
    static juce::Colour ground()  { return juce::Colour(0xff0a100c); }
    static juce::Colour gridInk() { return juce::Colour(0xff223129); }
    static juce::Colour labelInk(){ return juce::Colour(0xff5e7a6c); }
    static juce::Colour trace()   { return juce::Colour(0xff46d98a); }
    static juce::Colour holdInk() { return juce::Colour(0xffb8e6cd); }
    ...
    void paint(juce::Graphics& g) override {
...

        {
            ...
            fill.closeSubPath();
            g.setColour(trace().withAlpha(0.30f));
            g.fillPath(fill);
            juce::Path line;
            for (int c = 0; c < kCols; ++c) {
            ...
            g.setColour(holdInk().withAlpha(0.6f));
        ...
        g.setColour(juce::Colour(0xff31443a));
...
private:
    ...
    static juce::Colour heat(float t) {
        ...
        const juce::Colour sea(0xff10473a), mint(0xff9df2c0), hot(0xffeafff3);
