...
class Dx7Note {
 public:
  ...
  // Humus: init with the base pitch as a Q24 log2-frequency (the host's
  // microtonal Tuning), plus the nearest note number for the keyboard
  // level/rate scaling curves.
  void initLogfreq(const char patch[156], int32_t base_logfreq, int scalenote,
      int velocity);
